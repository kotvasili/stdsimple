...
function _classCallCheck(t, e) {
  ...
  function t(t, e) {
    return e = e || L, H.test(t) ? e.getElementsByClassName(t.slice(1)) : P.test(t) ? e.getElementsByTagName(t) : e.querySelectorAll(t);
  }function e(t) {
    if (!x) {
      var e = (x = L.implementation.createHTMLDocument()).createElement("base");e.href = L.location.href, x.head.appendChild(e);
    }return x.body.innerHTML = t, x.body.childNodes;
  }function i(t) {
    "loading" !== L.readyState ? t() : L.addEventListener("DOMContentLoaded", t);
  }function n(n, s) {
    if (!n) return this;if (n.cash && n !== T) return n;var a,
        o = n,
        r = 0;if (A(n)) o = R.test(n) ? L.getElementById(n.slice(1)) : W.test(n) ? e(n) : t(n, s);else if (S(n)) return i(n), this;if (!o) return this;if (o.nodeType || o === T) this[0] = o, this.length = 1;else for (a = this.length = o.length; r < a; r++) {
      this[r] = o[r];
    }return this;
  }function s(t, e) {
    return new n(t, e);
    ...
    return A(t) ? o : t.cash ? function (e) {
      return t.is(e);
    } : function (t, e) {
      return t === e;
    };
  }function l(t) {
    return s(D.call(t).filter(function (t, e, i) {
    ...
    var n,
        s = u(t, "_cashEvents"),
        o = s && s[e];o && (i ? (t.removeEventListener(e, i), (n = o.indexOf(i)) >= 0 && o.splice(n, 1)) : (a(o, function (i) {
      t.removeEventListener(e, i);
    }), o = []));
  }function k(t, e) {
    return "&" + encodeURIComponent(t) + "=" + encodeURIComponent(e).replace(/%20/g, "+");
  }function b(t) {
    var e = [];return a(t.options, function (t) {
    ...
    var n = A(e);n || !e.length ? a(t, n ? function (t) {
      ...
      I = function I() {},
      S = function S(t) {
    return (typeof t === "undefined" ? "undefined" : _typeof(t)) == (typeof I === "undefined" ? "undefined" : _typeof(I)) && t.call;
  },
      A = function A(t) {
    return "string" == typeof t;
      ...
      W = /<.+>/,
      P = /^\w+$/,
      j = s.fn = s.prototype = n.prototype = { cash: !0, length: 0, push: O, splice: $.splice, map: $.map, init: n };Object.defineProperty(j, "constructor", { value: s }), s.parseHTML = e, s.noop = I, s.isFunction = S, s.isString = A, s.extend = j.extend = function (t) {
    t = t || {};var e = D.call(arguments),
        i = e.length,
    ...
    }, each: a, matches: o, unique: l, isArray: Array.isArray, isNumeric: function isNumeric(t) {
      return !isNaN(parseFloat(t)) && isFinite(t);
    } });var z = s.uid = "_cash" + Date.now();j.extend({ data: function data(t, e) {
    ...
    } });var F = /\S+/g;j.extend({ addClass: function addClass(t) {
      var e = p(t);return e ? this.each(function (t) {
        var i = " " + t.className + " ";a(e, function (e) {
          f(t, e, i);
        });
      }) : this;
      ...
      if (void 0 !== e) return this[e ? "addClass" : "removeClass"](t);var i = p(t);return i ? this.each(function (t) {
        var e = " " + t.className + " ";a(i, function (i) {
          v(t, i) ? m(t, i) : f(t, i, e);
        });
      }) : this;
      ...
      if (!t) return this;var e = S(t) ? t : r(t);return s(B.call(this, function (i) {
        return e(i, t);
      }));
    }, first: function first() {
      return this.eq(0);
    }, get: function get(t) {
      return void 0 === t ? D.call(this) : t < 0 ? this[t + this.length] : this[t];
    }, index: function index(t) {
      var e = t ? s(t)[0] : this[0],
          i = t ? this : s(e).parent().children();return D.call(i).indexOf(e);
    }, last: function last() {
      return this.eq(-1);
    } });var N = function () {
    var t = /(?:^\w|[A-Z]|\b\w)/g,
    ...
    var t = {},
      ...
      if (i = N(i), t[i]) return t[i];var n = i.charAt(0).toUpperCase() + i.slice(1);return a((i + " " + ["webkit", "moz", "ms", "o"].join(n + " ") + n).split(" "), function (n) {
        if (n in e) return t[n] = i = t[i] = n, !1;
      }), t[i];
    };
  }();s.prefixedProp = q, s.camelCase = N, j.extend({ css: function css(t, e) {
      if (A(t)) return t = q(t), arguments.length > 1 ? this.each(function (i) {
        return i.style[t] = e;
      }) : T.getComputedStyle(this[0])[t];for (var i in t) {
        this.css(i, t[i]);
      }return this;
    } }), a(["Width", "Height"], function (t) {
    var e = t.toLowerCase();j[e] = function () {
      ...
      }return S(e) && (n = e, e = null), "ready" === t ? (i(n), this) : (e && (a = n, n = function n(t) {
        for (var i = t.target; !o(i, e);) {
    ...
    } });var V = L.documentElement;return j.extend({ position: function position() {
      ...
      var e,
        ...
        for (e = n; e && e.parentNode && e !== L.body.parentNode;) {
          e = e.parentNode, (!t || t && o(e, t)) && i.push(e);
        }
      }), l(i);
    }, prev: function prev() {
...
}, "es6-impl", "es3");var $jscomp$this = undefined;!function (t, e) {
  t.anime = e();
}(undefined, function () {
  function t(t) {
    if (!H.col(t)) try {
    ...
    for (var i = t.length, n = 2 <= arguments.length ? arguments[1] : void 0, s = [], a = 0; a < i; a++) {
      if (a in t) {
        var o = t[a];e.call(n, o, a, t) && s.push(o);
      }
    }return s;
  }function i(t) {
    ...
    var n = u(i),
        n = -1 < i.indexOf("scale") ? 1 : 0 + n;if (!(t = t.style.transform)) return n;for (var s = [], a = [], o = [], r = /(\w+)\((.+?)\)/g; s = r.exec(t);) {
      a.push(s[1]), o.push(s[2]);
    ...
    function i(i) {
      return i = void 0 === i ? 0 : i, t.el.getPointAtLength(1 <= e + i ? e + i : 0);
        ...
        s = i(-1),
        a = i(1);switch (t.property) {case "x":
        return n.x;case "y":
    ...
    return H.arr(t) ? W.apply(this, t) : P[t];
  }function T(t, e) {
    var i;return t.tweens.map(function (n) {
      var s = (n = x(n, e)).value,
          ...
          o = H.arr(s) ? s[0] : o,
          r = g(H.arr(s) ? s[1] : s, o),
          a = d(r) || d(o) || d(a);return n.from = w(o, a), n.to = w(r, a), n.start = i ? i.end : t.offset, n.end = n.start + n.delay + n.duration, n.easing = L(n.easing), n.elasticity = (1e3 - Math.min(Math.max(n.elasticity, 1), 999)) / 1e3, n.isPath = H.pth(s), n.isColor = H.col(n.from.original), n.isColor && (n.round = 1), i = n;
    });
  }function $(t, n) {
    ...
    var e,
        ...
        a = [],
        l = r(i, n);for (e in t) {
      l.hasOwnProperty(e) || "targets" === e || a.push({ name: e, offset: l.offset, tweens: M(t[e], n) });
    }return t = $(s, a), r(i, { children: [], animatables: s, animations: t, duration: D("duration", t, i, n), delay: D("delay", t, i, n) });
  }function O(t) {
    function i() {
      ...
      for (var i = 0, n = {}, s = v.animations, a = s.length; i < a;) {
        var o = s[i],
            r = o.animatable,
            l = (h = o.tweens)[c = h.length - 1];c && (l = e(h, function (e) {
          return t < e.end;
        ...
        } else f = c[0];j[o.type](r.target, o.property, f, n, r.id), o.currentValue = f, i++;
      }if (i = Object.keys(n).length) for (s = 0; s < i; s++) {
        I || (I = p(document.body, "transform") ? "transform" : "-webkit-transform"), v.animatables[s].target.style[I] = n[s].join(" ");
      ...
      var e = v.duration,
        ...
        var y = v.children,
            _ = y.length;if (g >= v.currentTime) for (var k = 0; k < _; k++) {
          y[k].seek(g);
        } else for (; _--;) {
          y[_].seek(g);
        }
      }(g >= p || !e) && (v.began || (v.began = !0, a("begin")), a("run")), g > r && g < e ? s(g) : (g <= r && 0 !== f && (s(0), m && o()), (g >= e && f !== e || !e) && (s(e), m || o())), a("update"), t >= e && (v.remaining ? (h = l, "alternate" === v.direction && (v.reversed = !v.reversed)) : (v.pause(), v.completed || (v.completed = !0, a("complete"), "Promise" in window && (u(), c = i()))), d = 0);
    }t = void 0 === t ? {} : t;var l,
        h,
        d = 0,
        u = null,
      ...
      l = t, h || (h = l), r((d + l - h) * O.speed);
    }, v.seek = function (t) {
      r(n(t));
    }, v.pause = function () {
      var t = z.indexOf(v);-1 < t && z.splice(t, 1), v.paused = !0;
    }, v.play = function () {
      v.paused && (v.paused = !1, h = 0, d = n(v.currentTime), z.push(v), F || N());
    }, v.reverse = function () {
    ...
    function t(t, e, i) {
      ...
      if (0 <= e && 1 >= e && 0 <= n && 1 >= n) {
        var a = new Float32Array(11);if (e !== i || n !== s) for (var o = 0; 11 > o; ++o) {
          a[o] = t(.1 * o, e, n);
        }return function (o) {
          if (e === i && n === s) return o;if (0 === o) return 0;if (1 === o) return 1;for (var r = 0, l = 1; 10 !== l && a[l] <= o; ++l) {
            r += .1;
          }var l = r + (o - a[--l]) / (a[l + 1] - a[l]) * .1,
              h = 3 * (1 - 3 * n + 3 * e) * l * l + 2 * (3 * n - 6 * e) * l + 3 * e;if (.001 <= h) {
            for (r = 0; 4 > r && 0 != (h = 3 * (1 - 3 * n + 3 * e) * l * l + 2 * (3 * n - 6 * e) * l + 3 * e); ++r) {
              var d = t(l, e, n) - o,
                  l = l - d / h;
            }o = l;
          } else if (0 === h) o = l;else {
            var l = r,
                r = r + .1,
                u = 0;do {
              0 < (h = t(d = l + (r - l) / 2, e, n) - o) ? r = d : l = d;
            } while (1e-7 < Math.abs(h) && 10 > ++u);o = d;
          }return t(o, i, s);
        };
      }
    };
    ...
    function t(t, e) {
      return 0 === t || 1 === t ? t : -Math.pow(2, 10 * (t - 1)) * Math.sin(2 * (t - 1 - e / (2 * Math.PI) * Math.asin(1)) * Math.PI / e);
        ...
        s = { linear: W(.25, .25, .75, .75) },
        a = {};for (e in n) {
      a.type = e, n[a.type].forEach(function (t) {
        return function (e, n) {
          s["ease" + t.type + i[n]] = H.fnc(e) ? e : W.apply($jscomp$this, e);
        };
      }(a)), a = { type: a.type };
    }return s;
  }(),
  ...
  }();return O.version = "2.2.0", O.speed = 1, O.running = z, O.remove = function (t) {
    t = C(t);for (var e = z.length; e--;) {
      for (var i = z[e], n = i.animations, a = n.length; a--;) {
        s(t, n[a].animatable.target) && (n.splice(a, 1), n.length || i.pause());
      }
    }
  }, O.getValue = m, O.path = function (e, i) {
  ...
  }, O.bezier = W, O.easings = P, O.timeline = function (t) {
    var e = O(t);return e.pause(), e.duration = 0, e.add = function (i) {
      return e.children.forEach(function (t) {
        t.began = !0, t.completed = !0;
      }), n(i).forEach(function (i) {
        var n = r(i, o(A, t || {}));n.targets = n.targets || t.targets, i = e.duration;var s = n.offset;n.autoplay = !1, n.direction = e.direction, n.offset = H.und(s) ? i : g(s, i), e.began = !0, e.completed = !0, e.seek(n.offset), (n = O(n)).began = !0, n.completed = !0, n.duration > i && (e.duration = n.duration), e.children.push(n);
  ...
  jQuery.fn[e] = function (n) {
    if (t.prototype[n]) {
      var s = Array.prototype.slice.call(arguments, 1);if ("get" === n.slice(0, 3)) {
        var a = this.first()[0][i];return a[n].apply(a, s);
  ...
  var n = { top: !1, right: !1, bottom: !1, left: !1 },
      ...
      o = t.scrollTop,
      r = e.left - a,
      l = e.top - o;return (r < s.left + i || r < i) && (n.left = !0), (r + e.width > s.right - i || r + e.width > window.innerWidth - i) && (n.right = !0), (l < s.top + i || l < i) && (n.top = !0), (l + e.height > s.bottom - i || l + e.height > window.innerHeight - i) && (n.bottom = !0), n;
}, M.checkPossibleAlignments = function (t, e, i, n) {
  var s = { top: !0, right: !0, bottom: !0, left: !0, spaceOnTop: null, spaceOnRight: null, spaceOnBottom: null, spaceOnLeft: null },
      a = "visible" === getComputedStyle(e).overflow,
      o = e.getBoundingClientRect(),
      r = t.getBoundingClientRect(),
      l = e.scrollLeft,
      h = e.scrollTop,
      d = i.left - l,
      u = i.top - h;return s.spaceOnRight = a ? window.innerWidth - (r.left + i.width) : e.offsetWidth - (d + i.width), (!a && d + i.width > e.offsetWidth || a && r.left + i.width > window.innerWidth) && (s.left = !1), s.spaceOnLeft = a ? r.right - i.width : d - i.width + r.width, (!a && d - i.width + r.width < 0 || a && r.right - i.width < 0) && (s.right = !1), s.spaceOnBottom = a ? window.innerHeight - (r.top + i.height + n) : o.height - (u + i.height + n), (!a && u + i.height + n > o.height || a && r.top + i.height + n > window.innerHeight) && (s.top = !1), s.spaceOnTop = a ? r.bottom - (i.height + n) : u - (i.height + n), (!a && u - i.height - n < 0 || a && r.bottom - i.height - n < 0) && (s.bottom = !1), s;
  ...
  var n = void 0,
    ...
    r = !1 === i.leading ? 0 : getTime(), o = null, a = t.apply(n, s), n = s = null;
  };return function () {
    var h = getTime();r || !1 !== i.leading || (r = h);var d = e - (h - r);return n = this, s = arguments, d <= 0 ? (clearTimeout(o), o = null, r = h, a = t.apply(n, s), n = s = null) : o || !1 === i.trailing || (o = setTimeout(l, d)), a;
  };
}, function (t, e) {
  "use strict";
  var i = { accordion: !0, onOpenStart: void 0, onOpenEnd: void 0, onCloseStart: void 0, onCloseEnd: void 0, inDuration: 300, outDuration: 300 },
      n = function () {
    function n(e, i) {
      _classCallCheck(this, n), e.M_Collapsible && e.M_Collapsible.destroy(), this.el = e, this.$el = t(e), this.el.M_Collapsible = this, this.options = t.extend({}, n.defaults, i), this._setupEventHandlers();var s = this.$el.children("li.active").children(".collapsible-body");this.options.accordion ? s.first().css("display", "block") : s.css("display", "block");
        ...
        var i = t(e.target).closest(".collapsible-header");if (e.target && i.length) {
          var n = i.closest(".collapsible");if (n[0] === this.el) {
            var s = i.closest("li"),
                ...
                r = a.index(s);o ? this.close(r) : this.open(r);
          }
        }
      } }, { key: "_animateIn", value: function value(t) {
        var i = this,
            n = this.$el.children("li").eq(t);if (n.length) {
          var s = n.children(".collapsible-body");e.remove(s[0]), s.css({ display: "block", overflow: "hidden", height: 0, paddingTop: "", paddingBottom: "" });var a = s.css("padding-top"),
              o = s.css("padding-bottom"),
              r = s[0].scrollHeight;s.css({ paddingTop: 0, paddingBottom: 0 }), e({ targets: s[0], height: r, paddingTop: a, paddingBottom: o, duration: this.options.inDuration, easing: "easeInOutCubic", complete: function complete(t) {
    ...
    function n(e, i) {
      _classCallCheck(this, n), e.M_Dropdown && e.M_Dropdown.destroy(), this.el = e, this.$el = t(e), this.el.M_Dropdown = this, n._dropdowns.push(this), this.id = M.getIdFromTrigger(e), this.dropdownEl = document.getElementById(this.id), this.$dropdownEl = t(this.dropdownEl), this.options = t.extend({}, n.defaults, i), this.isOpen = !1, this.focusedIndex = -1, this.filterQuery = [], this.$el.after(this.dropdownEl), this._makeDropdownFocusable(), this._resetFilterQueryBound = this._resetFilterQuery.bind(this), this._handleDocumentClickBound = this._handleDocumentClick.bind(this), this._handleDropdownKeydownBound = this._handleDropdownKeydown.bind(this), this._handleTriggerKeydownBound = this._handleTriggerKeydown.bind(this), this._setupEventHandlers();
        ...
        var i = e.toElement || e.relatedTarget,
            ...
            s = !1,
            a = t(i).closest(".dropdown-trigger");a.length && a[0].M_Dropdown && a[0].M_Dropdown.isOpen && (s = !0), s || n || this.close();
        ...
        if (e.which === M.keys.TAB) e.preventDefault(), this.close();else if (e.which !== M.keys.ARROW_DOWN && e.which !== M.keys.ARROW_UP || !this.isOpen) {
          ...
          e.preventDefault();var s = e.which === M.keys.ARROW_DOWN ? 1 : -1;this.focusedIndex = Math.max(Math.min(this.focusedIndex + s, this.dropdownEl.children.length - 1), 0), this._focusFocusedItem();
            ...
            o = [9, 13, 27, 38, 40];if (a && -1 === o.indexOf(e.which)) {
        ...
        this.el.offsetParent.getBoundingClientRect();var t = { left: this.el.offsetLeft, top: this.el.offsetTop, width: this.el.offsetWidth, height: this.el.offsetHeight },
            ...
            d = "top",
            u = this.options.alignment;if (o += this.options.coverTrigger ? 0 : e.height, h.top || (h.bottom ? d = "bottom" : h.spaceOnTop > h.spaceOnBottom ? (d = "bottom", n += h.spaceOnTop, o -= h.spaceOnTop) : n += h.spaceOnBottom), !h[u]) {
          var c = "left" === u ? "right" : "left";h[c] ? u = c : h.spaceOnLeft > h.spaceOnRight ? (u = "right", s += h.spaceOnLeft, a -= h.spaceOnLeft) : (u = "left", s += h.spaceOnRight);
        }return "bottom" === d && (o = o - i.height + (this.options.coverTrigger ? e.height : 0)), "right" === u && (a = a - i.width + e.width), { x: a, y: o, verticalAlignment: d, horizontalAlignment: u, height: n, width: s };
      } }, { key: "_animateIn", value: function value(t) {
    ...
    function n(e, i) {
      _classCallCheck(this, n), e.M_Modal && e.M_Modal.destroy(), this.el = e, this.$el = t(e), this.el.M_Modal = this, this.options = t.extend({}, n.defaults, i), this.isOpen = !1, this.id = this.$el.attr("id"), this._openingTrigger = void 0, this.$overlay = t('<div class="modal-overlay"></div>'), n._increment++, n._count++, this.$overlay[0].style.zIndex = 1e3 + 2 * n._increment, this.el.style.zIndex = 1e3 + 2 * n._increment + 1, this._setupEventHandlers();
        ...
        var i = this;e({ targets: this.$overlay[0], opacity: 0, duration: this.options.outDuration, easing: "easeOutQuart" });var n = { targets: this.el, duration: this.options.outDuration, easing: "easeOutCubic", complete: function complete() {
            i.el.style.display = "none", "function" == typeof i.options.complete && i.options.complete.call(i, i.el), i.$overlay.remove();
    ...
    function n(e, i) {
      _classCallCheck(this, n), e.M_Materialbox && e.M_Materialbox.destroy(), this.el = e, this.$el = t(e), this.el.M_Materialbox = this, this.options = t.extend({}, n.defaults, i), this.overlayActive = !1, this.doneAnimating = !0, this.placeholder = t("<div></div>").addClass("material-placeholder"), this.originalWidth = 0, this.originalHeight = 0, this.originInlineStyles = this.$el.attr("style"), this.caption = this.el.getAttribute("data-caption") || "", this.$el.before(this.placeholder), this.placeholder.append(this.$el), this._setupEventHandlers();
        ...
        var t = this,
            ...
            t.placeholder.css({ height: "", width: "", position: "", top: "", left: "" }), t.$el.removeAttr("style"), t.$el.attr("style", t.originInlineStyles), t.$el.removeClass("active"), t.doneAnimating = !0, t.ancestorsChanged.length && t.ancestorsChanged.css("overflow", "");
          } };e(i);
...
}(cash, anime), function (t) {
  "use strict";
  var e = {},
      i = function () {
    function i(e, n) {
      _classCallCheck(this, i), e.M_Parallax && e.M_Parallax.destroy(), this.el = e, this.$el = t(e), this.el.M_Parallax = this, this.options = t.extend({}, i.defaults, n), this.$img = this.$el.find("img").first(), this._updateParallax(), this._setupEventHandlers(), this._setupStyles(), i._parallaxes.push(this);
    }return _createClass(i, [{ key: "destroy", value: function value() {} }, { key: "_setupEventHandlers", value: function value() {
        ...
        var t = this.$el.height() > 0 ? this.el.parentNode.offsetHeight : 500,
            ...
            o = e * ((s + a - n) / (t + a));i > s && n < s + a && (this.$img[0].style.transform = "translate3D(-50%, " + o + "px, 0)");
      } }], [{ key: "init", value: function value(t, e) {
        var n = [];return t.each(function () {
          n.push(new i(this, e));
        }), n;
      } }, { key: "getInstance", value: function value(t) {
        ...
        for (var t = 0; t < i._parallaxes.length; t++) {
          var e = i._parallaxes[t];e._updateParallax.call(e);
        }
      } }, { key: "defaults", get: function get() {
        return e;
      } }]), i;
    ...
    function n(e, i) {
      _classCallCheck(this, n), e.M_Tabs && e.M_Tabs.destroy(), this.$el = t(e), this.el = e, this.options = t.extend({}, n.defaults, i), this.el.M_Tabs = this, this.$tabLinks = this.$el.children("li.tab").children("a"), this.index = 0, this._setTabsAndTabWidth(), this._setupActiveTabLink(), this._createIndicator(), this.options.swipeable ? this._setupSwipeableTabs() : this._setupNormalTabs(), this._setupEventHandlers();
        ...
        var i = this,
          ...
          this._setTabsAndTabWidth(), this.$activeTabLink.removeClass("active");var a = this.$content;this.$activeTabLink = s, this.$content = t(M.escapeHash(s[0].hash)), this.$tabLinks = this.$el.children("li.tab").children("a"), this.$activeTabLink.addClass("active");var o = this.index;this.index = Math.max(this.$tabLinks.index(s), 0), this.options.swipeable ? this._tabsCarousel && this._tabsCarousel.set(this.index, function () {
            "function" == typeof i.options.onShow && i.options.onShow.call(i, i.$content[0]);
          }) : this.$content.length && (this.$content[0].style.display = "block", this.$content.addClass("active"), "function" == typeof this.options.onShow && this.options.onShow.call(this, this.$content[0]), a.length && !a.is(this.$content) && (a[0].style.display = "none", a.removeClass("active"))), this._animateIndicator(o), e.preventDefault();
        }
        ...
        });var n = t('<div class="tabs-content carousel carousel-slider"></div>');i.first().before(n), n.append(i), i[0].style.display = "", this._tabsCarousel = new M.Carousel(n[0], { fullWidth: !0, noWrap: !0, onCycleTo: function onCycleTo(i) {
  ...
  var i = { exitDelay: 200, enterDelay: 0, html: null, margin: 5, inDuration: 250, outDuration: 200, position: "bottom", transitionMovement: 10 },
      n = function () {
    function n(e, i) {
      _classCallCheck(this, n), e.M_Tooltip && e.M_Tooltip.destroy(), this.el = e, this.$el = t(e), this.el.M_Tooltip = this, this.options = t.extend({}, n.defaults, i), this.isOpen = !1, this.isHovered = !1, this._appendTooltipEl(), this._setupEventHandlers();
    }return _createClass(n, [{ key: "destroy", value: function value() {
        ...
        var s = M.getDocumentScrollLeft(),
            ...
            d = M.checkWithinContainer(document.body, l, h);return d.left ? o = h : d.right && (o -= o + i - window.innerWidth), d.top ? r = h : d.bottom && (r -= r + n - window.innerHeight), { x: o + s, y: r + a };
      } }, { key: "_animateIn", value: function value() {
  ...
  function e(t) {
    ...
    var e,
        n,
        s = { top: 0, left: 0 },
        a = t && t.ownerDocument;return e = a.documentElement, void 0 !== t.getBoundingClientRect && (s = t.getBoundingClientRect()), n = i(a), { top: s.top + n.pageYOffset - e.clientTop, left: s.left + n.pageXOffset - e.clientLeft };
  }function s(t) {
    ...
    var i = a(e);null !== i && (h.show(e, i), "ontouchstart" in t && (i.addEventListener("touchend", h.hide, !1), i.addEventListener("touchcancel", h.hide, !1)), i.addEventListener("mouseup", h.hide, !1), i.addEventListener("mouseleave", h.hide, !1), i.addEventListener("dragend", h.hide, !1));
  }var r = r || {},
      l = document.querySelectorAll.bind(document),
      h = { duration: 750, show: function show(t, e) {
      if (2 === t.button) return !1;var i = e || this,
          a = document.createElement("div");a.className = "waves-ripple", i.appendChild(a);var o = n(i),
          r = t.pageY - o.top,
          l = t.pageX - o.left,
          d = "scale(" + i.clientWidth / 100 * 10 + ")";"touches" in t && (r = t.touches[0].pageY - o.top, l = t.touches[0].pageX - o.left), a.setAttribute("data-hold", Date.now()), a.setAttribute("data-scale", d), a.setAttribute("data-x", l), a.setAttribute("data-y", r);var u = { top: r + "px", left: l + "px" };a.className = a.className + " waves-notransition", a.setAttribute("style", s(u)), a.className = a.className.replace("waves-notransition", ""), u["-webkit-transform"] = d, u["-moz-transform"] = d, u["-ms-transform"] = d, u["-o-transform"] = d, u.transform = d, u.opacity = "1", u["-webkit-transition-duration"] = h.duration + "ms", u["-moz-transition-duration"] = h.duration + "ms", u["-o-transition-duration"] = h.duration + "ms", u["transition-duration"] = h.duration + "ms", u["-webkit-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", u["-moz-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", u["-o-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", u["transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", a.setAttribute("style", s(u));
      ...
      for (var e = 0; e < t.length; e++) {
        var i = t[e];if ("input" === i.tagName.toLowerCase()) {
          var n = i.parentNode;if ("i" === n.tagName.toLowerCase() && -1 !== n.className.indexOf("waves-effect")) continue;var s = document.createElement("i");s.className = i.className + " waves-input-wrapper";var a = i.getAttribute("style");a || (a = ""), s.setAttribute("style", a), i.className = "waves-button-input", i.removeAttribute("style"), n.replaceChild(s, i), s.appendChild(i);
        }
      }
    } },
    ...
    "duration" in (e = e || {}) && (h.duration = e.duration), h.wrapInput(l(".waves-effect")), "ontouchstart" in t && document.body.addEventListener("touchstart", o, !1), document.body.addEventListener("mousedown", o, !1);
  }, r.attach = function (e) {
    "input" === e.tagName.toLowerCase() && (h.wrapInput([e]), e = e.parentNode), "ontouchstart" in t && e.addEventListener("touchstart", o, !1), e.addEventListener("mousedown", o, !1);
  ...
  var i = { throttle: 100, scrollOffset: 200, activeClass: "active", getActiveElement: function getActiveElement(t) {
      ...
      n = function () {
    function n(e, i) {
      _classCallCheck(this, n), e.M_ScrollSpy && e.M_ScrollSpy.destroy(), this.el = e, this.$el = t(e), this.el.M_ScrollSpy = this, this.options = t.extend({}, n.defaults, i), n._elements.push(this), n._count++, n._increment++, this.tickId = -1, this.id = n._increment, this._setupEventHandlers(), this._handleWindowScroll();
    }return _createClass(n, [{ key: "destroy", value: function value() {
        ...
        for (var s = t(i.target), a = n._elements.length - 1; a >= 0; a--) {
          var o = n._elements[a];if (s.is('a[href="#' + o.$el.attr("id") + '"]')) {
            i.preventDefault();var r = o.$el.offset().top + 1;e({ targets: [document.documentElement, document.body], scrollTop: r - o.options.scrollOffset, duration: 400, easing: "easeOutCubic" });break;
          }
        }
      } }, { key: "_handleWindowScroll", value: function value() {
        n._ticks++;for (var t = M.getDocumentScrollTop(), e = M.getDocumentScrollLeft(), i = e + window.innerWidth, s = t + window.innerHeight, a = n._findElements(t, i, s, e), o = 0; o < a.length; o++) {
          var r = a[o];r.tickId < 0 && r._enter(), r.tickId = n._ticks;
        }for (var l = 0; l < n._elementsInView.length; l++) {
          var h = n._elementsInView[l],
              d = h.tickId;d >= 0 && d !== n._ticks && (h._exit(), h.tickId = -1);
        }n._elementsInView = a;
      } }, { key: "_enter", value: function value() {
        n._visibleElements = n._visibleElements.filter(function (t) {
          return 0 != t.height();
        }), n._visibleElements[0] ? (t(this.options.getActiveElement(n._visibleElements[0].attr("id"))).removeClass(this.options.activeClass), n._visibleElements[0][0].M_ScrollSpy && this.id < n._visibleElements[0][0].M_ScrollSpy.id ? n._visibleElements.unshift(this.$el) : n._visibleElements.push(this.$el)) : n._visibleElements.push(this.$el), t(this.options.getActiveElement(n._visibleElements[0].attr("id"))).addClass(this.options.activeClass);
      } }, { key: "_exit", value: function value() {
        var e = this;n._visibleElements = n._visibleElements.filter(function (t) {
          return 0 != t.height();
        }), n._visibleElements[0] && (t(this.options.getActiveElement(n._visibleElements[0].attr("id"))).removeClass(this.options.activeClass), n._visibleElements = n._visibleElements.filter(function (t) {
          return t.attr("id") != e.$el.attr("id");
        }), n._visibleElements[0] && t(this.options.getActiveElement(n._visibleElements[0].attr("id"))).addClass(this.options.activeClass));
      } }], [{ key: "init", value: function value(t, e) {
        var i = [];return t.each(function () {
          i.push(new n(this, e));
        }), i;
      ...
      } }, { key: "_findElements", value: function value(t, e, i, s) {
        for (var a = [], o = 0; o < n._elements.length; o++) {
          var r = n._elements[o],
            ...
            var h = r.$el.offset().top,
                d = r.$el.offset().left,
                u = d + r.$el.width(),
                c = h + r.$el.height();!(d > e || u < s || h > i || c < l) && a.push(r);
          }
        }return a;
      } }, { key: "defaults", get: function get() {
        return i;
  ...
  var e = { data: {}, limit: 1 / 0, onAutocomplete: null, minLength: 1, sortFunction: function sortFunction(t, e, i) {
    ...
    function i(e, n) {
      _classCallCheck(this, i), e.M_Autocomplete && e.M_Autocomplete.destroy(), this.el = e, this.$el = t(e), this.el.M_Autocomplete = this, this.options = t.extend({}, i.defaults, n), this.isOpen = !1, this.count = 0, this.activeIndex = -1, this.oldVal, this.$inputField = this.$el.closest(".input-field"), this.$active = t(), this._setupDropdown(), this._setupEventHandlers();
        ...
        "keyup" === t.type && (i._keydown = !1), this.count = 0;var e = this.el.value.toLowerCase();13 !== t.keyCode && 38 !== t.keyCode && 40 !== t.keyCode && (this.oldVal !== e && (this._removeAutocomplete(), e.length >= this.options.minLength && (this.isOpen = !0, this._renderDropdown(this.options.data, e))), this.oldVal = e);
      } }, { key: "_handleInputKeydown", value: function value(e) {
        i._keydown = !0;var n = e.keyCode,
            s = void 0,
            a = t(this.container).children("li").length;13 === n && this.activeIndex >= 0 ? (s = t(this.container).children("li").eq(this.activeIndex)).length && (this.selectOption(s), e.preventDefault()) : 38 !== n && 40 !== n || (e.preventDefault(), 38 === n && this.activeIndex > 0 && this.activeIndex--, 40 === n && this.activeIndex < a - 1 && this.activeIndex++, this.$active.removeClass("active"), this.activeIndex >= 0 && (this.$active = t(this.container).children("li").eq(this.activeIndex), this.$active.addClass("active")));
        ...
        var i = e.find("img"),
            ...
            s = n + t.length - 1,
            a = e.text().slice(0, n),
            o = e.text().slice(n, s + 1),
            r = e.text().slice(s + 1);e.html("<span>" + a + "<span class='highlight'>" + o + "</span>" + r + "</span>"), i.length && e.prepend(i);
        ...
        var n = this;this._removeAutocomplete();var s = [];for (var a in e) {
          if (e.hasOwnProperty(a) && -1 !== a.toLowerCase().indexOf(i)) {
            if (this.count >= this.options.limit) break;var o = { data: e[a], key: a };s.push(o), this.count++;
          }
        }s.sort(function (t, e) {
  ...
  M.updateTextFields = function () {
    ...
    var e = "input[type=text], input[type=password], input[type=email], input[type=url], input[type=tel], input[type=number], input[type=search], textarea";t(document).on("change", e, function () {
      ...
      var e = t(this);e.data("original-height", e.height()), e.data("previous-length", this.value.length);
      ...
      M.textareaAutoResize(t(this));
    }), t(document).on("autoresize", ".materialize-textarea", function () {
      M.textareaAutoResize(t(this));
  ...
  var i = { indicators: !0, height: 400, duration: 500, interval: 6e3 },
      n = function () {
    function n(i, s) {
      var a = this;_classCallCheck(this, n), i.M_Slider && i.M_Slider.destroy(), this.el = i, this.$el = t(i), this.el.M_Slider = this, this.options = t.extend({}, n.defaults, s), this.$slider = this.$el.find(".slides"), this.$slides = this.$slider.children("li"), this.activeIndex = this.$slider.find(".active").index(), -1 != this.activeIndex && (this.$active = this.$slides.eq(this.activeIndex)), this._setSliderHeight(), this.$slides.find(".caption").each(function (t) {
        a._animateCaptionIn(t, 0);
      }), this.$slides.find("img").each(function (e) {
      ...
      }), this._setupIndicators(), this.$active ? this.$active.css("display", "block") : (this.$slides.first().addClass("active"), e({ targets: this.$slides.first()[0], opacity: 1, duration: this.options.duration, easing: "easeOutQuad" }), this.activeIndex = 0, this.$active = this.$slides.eq(this.activeIndex), this.options.indicators && this.$indicators.eq(this.activeIndex).addClass("active")), this.$active.find("img").each(function (t) {
        e({ targets: a.$active.find(".caption")[0], opacity: 1, translateX: 0, translateY: 0, duration: a.options.duration, easing: "easeOutQuad" });
  ...
  var e = { data: [], placeholder: "", secondaryPlaceholder: "", autocompleteOptions: {}, limit: 1 / 0, onChipAdd: null, onChipSelect: null, onChipDelete: null },
    ...
    function i(e, n) {
      _classCallCheck(this, i), e.M_Chips && e.M_Chips.destroy(), this.el = e, this.$el = t(e), this.el.M_Chips = this, this.options = t.extend({}, i.defaults, n), this.$el.addClass("chips input-field"), this.chipsData = [], this.$chips = t(), this._setupInput(), this.hasAutocomplete = Object.keys(this.options.autocompleteOptions).length > 0, this.$input.attr("id") || this.$input.attr("id", M.guid()), this.options.data.length && (this.chipsData = this.options.data, this._renderChips(this.chipsData)), this.hasAutocomplete && this._setupAutocomplete(), this._setPlaceholder(), this._setupLabel(), this._setupEventHandlers();
        ...
        i._keydown = !0;var n = t(e.target).closest(".chips"),
            s = e.target && n.length;if (!t(e.target).is("input, textarea") && s) {
          var a = n[0].M_Chips;if (8 === e.keyCode || 46 === e.keyCode) {
            e.preventDefault();var o = a.chipsData.length;if (a._selectedChip) {
              var r = a._selectedChip.index();a.deleteChip(r), a._selectedChip = null, o = r - 1;
            }a.chipsData.length && a.selectChip(o);
          } else if (37 === e.keyCode) {
            if (a._selectedChip) {
              var l = a._selectedChip.index() - 1;if (l < 0) return;a.selectChip(l);
            }
          } else if (39 === e.keyCode && a._selectedChip) {
            var h = a._selectedChip.index() + 1;h >= a.chipsData.length ? a.$input[0].focus() : a.selectChip(h);
          }
        }
  ...
  "use strict";
  var e = { top: 0, bottom: 1 / 0, offset: 0 },
      i = function () {
    function i(e, n) {
      _classCallCheck(this, i), e.M_Pushpin && e.M_Pushpin.destroy(), this.el = e, this.$el = t(e), this.el.M_Pushpin = this, this.options = t.extend({}, i.defaults, n), this.originalOffset = this.el.offsetTop, i._pushpins.push(this), this._setupEventHandlers(), this._updatePosition();
    }return _createClass(i, [{ key: "destroy", value: function value() {
        this.el.style.top = null, this._removePinClasses(), this._removeEventHandlers();var t = i._pushpins.indexOf(this);i._pushpins.splice(t, 1);
      } }, { key: "_setupEventHandlers", value: function value() {
    ...
    function n(e, i) {
      _classCallCheck(this, n), e.M_FloatingActionButton && e.M_FloatingActionButton.destroy(), this.el = e, this.$el = t(e), this.el.M_FloatingActionButton = this, this.options = t.extend({}, n.defaults, i), this.isOpen = !1, this.$anchor = this.$el.children("a").first(), this.$menu = this.$el.children("ul").first(), this.$floatingBtns = this.$el.find("ul .btn-floating"), this.$floatingBtnsReverse = this.$el.find("ul .btn-floating").reverse(), this.offsetY = 0, this.offsetX = 0, "top" === this.options.direction ? (this.$el.addClass("direction-top"), this.offsetY = 40) : "right" === this.options.direction ? (this.$el.addClass("direction-right"), this.offsetX = -40) : "bottom" === this.options.direction ? (this.$el.addClass("direction-bottom"), this.offsetY = -40) : (this.$el.addClass("direction-left"), this.offsetX = 40), this._setupEventHandlers();
        ...
        var e = this,
            ...
            o = t('<div class="fab-backdrop"></div>'),
          ...
          e.$el.css({ transform: "", transition: "transform .2s cubic-bezier(0.550, 0.085, 0.680, 0.530), background-color 0s linear .2s" }), e.$anchor.css({ overflow: "visible", transform: "", transition: "transform .2s" }), setTimeout(function () {
            e.$el.css({ overflow: "hidden", "background-color": r }), o.css({ transform: "scale(" + i + ")", transition: "transform .2s cubic-bezier(0.550, 0.055, 0.675, 0.190)" }), e.$menu.children("li").children("a").css({ opacity: 1 }), e._handleDocumentClickBound = e._handleDocumentClick.bind(e), window.addEventListener("scroll", e._handleCloseBound, !0), document.body.addEventListener("click", e._handleDocumentClickBound, !0);
          }, 100);
        }, 0);
  ...
  var e = { format: "mmm dd, yyyy", parse: null, defaultDate: null, setDefaultDate: !1, disableWeekends: !1, disableDayFn: null, firstDay: 0, minDate: null, maxDate: null, yearRange: 10, minYear: 0, maxYear: 9999, minMonth: void 0, maxMonth: void 0, startRange: null, endRange: null, isRTL: !1, showMonthAfterYear: !1, showDaysInNextAndPreviousMonths: !1, container: null, i18n: { clear: "Clear", today: "Today", done: "Ok", previousMonth: "‹", nextMonth: "›", months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], monthsShort: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], weekdaysShort: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], weekdays: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], weekdaysAbbrev: ["S", "M", "T", "W", "T", "F", "S"] }, events: [], onSelect: null, onOpen: null, onClose: null, onDraw: null },
    ...
    function i(e, n) {
      _classCallCheck(this, i), e.M_Datepicker && e.M_Datepicker.destroy(), this.el = e, this.$el = t(e), this.el.M_Datepicker = this, this.options = t.extend({}, i.defaults, n), this.options.minDate && this.options.minDate.setHours(0, 0, 0, 0), this.options.maxDate && this.options.maxDate.setHours(0, 0, 0, 0), this.id = M.guid(), this._setupVariables(), this._insertHTMLIntoDOM(), this._setupModal(), this._setupEventHandlers(), this.options.defaultDate || (this.options.defaultDate = new Date(Date.parse(this.el.value)), this.options.setDefaultDate = !0);var s = this.options.defaultDate;i._isDate(s) ? this.options.setDefaultDate ? this.setDate(s, !0) : this.gotoDate(s) : this.gotoDate(new Date()), this.isOpen = !1;
        ...
        var t = this;this.modalEl.id = "modal-" + this.id, this.modal = new M.Modal(this.modalEl, { complete: function complete() {
            t.isOpen = !1;
          } });
      } }, { key: "toString", value: function value(t) {
        var e = this;return t = t || this.options.format, i._isDate(this.date) ? t.split(/(d{1,4}|m{1,4}|y{4}|yy|!.)/g).map(function (t) {
          return e.formats[t] ? e.formats[t]() : t;
        }).join("") : "";
      } }, { key: "setDate", value: function value(t, e) {
        if (!t) return this.date = null, this._renderDateDisplay(), this.draw();if ("string" == typeof t && (t = new Date(Date.parse(t))), i._isDate(t)) {
          var n = this.options.minDate,
              s = this.options.maxDate;i._isDate(n) && t < n ? t = n : i._isDate(s) && t > s && (t = s), this.date = new Date(t.getTime()), this._renderDateDisplay(), i._setToStartOfDay(this.date), this.gotoDate(this.date), e || "function" != typeof this.options.onSelect || this.options.onSelect.call(this, this.date);
        }
        ...
        var t = i._isDate(this.date) ? this.date : new Date(),
            ...
            a = t.getDate();this.yearTextEl.innerHTML = t.getFullYear(), this.dateTextEl.innerHTML = n + ", " + s + " " + a;
      } }, { key: "gotoDate", value: function value(t) {
        var e = !0;if (i._isDate(t)) {
          if (this.calendars) {
            var n = new Date(this.calendars[0].year, this.calendars[0].month, 1),
                s = new Date(this.calendars[this.calendars.length - 1].year, this.calendars[this.calendars.length - 1].month, 1),
                a = t.getTime();s.setMonth(s.getMonth() + 1), s.setDate(s.getDate() - 1), e = a < n.getTime() || s.getTime() < a;
        ...
        this.calendars[0].month--, this.adjustCalendars();
      } }, { key: "render", value: function value(t, e, n) {
        var s = this.options,
            a = new Date(),
            o = i._getDaysInMonth(t, e),
            r = new Date(t, e, 1).getDay(),
            l = [],
            h = [];i._setToStartOfDay(a), s.firstDay > 0 && (r -= s.firstDay) < 0 && (r += 7);for (var d = 0 === e ? 11 : e - 1, u = 11 === e ? 0 : e + 1, c = 0 === e ? t - 1 : t, p = 11 === e ? t + 1 : t, v = i._getDaysInMonth(c, d), f = o + r, m = f; m > 7;) {
          m -= 7;
        }f += 7 - m;for (var g = !1, y = 0, _ = 0; y < f; y++) {
          var k = new Date(t, e, y - r + 1),
              b = !!i._isDate(this.date) && i._compareDates(k, this.date),
              w = i._compareDates(k, a),
              C = -1 !== s.events.indexOf(k.toDateString()),
              E = y < r || y >= o + r,
              M = y - r + 1,
              x = e,
              L = t,
              T = s.startRange && i._compareDates(s.startRange, k),
              $ = s.endRange && i._compareDates(s.endRange, k),
              D = s.startRange && s.endRange && s.startRange < k && k < s.endRange,
              B = s.minDate && k < s.minDate || s.maxDate && k > s.maxDate || s.disableWeekends && i._isWeekend(k) || s.disableDayFn && s.disableDayFn(k);E && (y < r ? (M = v + M, x = d, L = c) : (M -= o, x = u, L = p));var O = { day: M, month: x, year: L, hasEvent: C, isSelected: b, isToday: w, isDisabled: B, isEmpty: E, isStartRange: T, isEndRange: $, isInRange: D, showDaysInNextAndPreviousMonths: s.showDaysInNextAndPreviousMonths };h.push(this.renderDay(O)), 7 == ++_ && (l.push(this.renderRow(h, s.isRTL, g)), h = [], _ = 0, g = !1);
      ...
      } }, { key: "renderTitle", value: function value(e, i, n, s, a, o) {
        var r = void 0,
            l = void 0,
            h = void 0,
            d = this.options,
          ...
          h.push('<option value="' + (n === a ? r - i : 12 + r - i) + '"' + (r === s ? ' selected="selected"' : "") + (u && r < d.minMonth || c && r > d.maxMonth ? 'disabled="disabled"' : "") + ">" + d.i18n.months[r] + "</option>");
        ...
        if (this.isOpen || t) {
          var e = this.options,
              ...
              a = e.maxMonth,
              o = "",
              r = void 0;this._y <= i && (this._y = i, !isNaN(s) && this._m < s && (this._m = s)), this._y >= n && (this._y = n, !isNaN(a) && this._m > a && (this._m = a)), r = "pika-title-" + Math.random().toString(36).replace(/[^a-z]+/g, "").substr(0, 2);for (var l = 0; l < 1; l++) {
            this._renderDateDisplay(), o += this.renderTitle(this, l, this.calendars[l].year, this.calendars[l].month, this.calendars[0].year, r) + this.render(this.calendars[l].year, this.calendars[l].month, r);
          }this.calendarEl.innerHTML = o;var h = this.calendarEl.querySelector(".pika-select-year"),
              d = this.calendarEl.querySelector(".pika-select-month");new M.Select(h, { classes: "select-year" }), new M.Select(d, { classes: "select-month" }), h.addEventListener("change", this._handleYearChange.bind(this)), d.addEventListener("change", this._handleMonthChange.bind(this)), "function" == typeof this.options.onDraw && this.options.onDraw(this);
        }
      } }, { key: "_setupEventHandlers", value: function value() {
        ...
        var e = this;this.$modalEl = t(i._template), this.modalEl = this.$modalEl[0], this.calendarEl = this.modalEl.querySelector(".pika-single"), this.yearTextEl = this.modalEl.querySelector(".year-text"), this.dateTextEl = this.modalEl.querySelector(".date-text"), this.clearBtn = this.modalEl.querySelector(".datepicker-clear"), this.todayBtn = this.modalEl.querySelector(".datepicker-today"), this.doneBtn = this.modalEl.querySelector(".datepicker-done"), this.formats = { dd: function dd() {
        ...
        var e = void 0;t.firedBy !== this && (e = this.options.parse ? this.options.parse(this.el.value, this.options.format) : new Date(Date.parse(this.el.value)), i._isDate(e) && this.setDate(e));
  ...
  var e = { dialRadius: 135, outerRadius: 105, innerRadius: 70, tickRadius: 20, duration: 350, container: null, defaultTime: "now", fromnow: 0, doneText: "Ok", clearText: "Clear", cancelText: "Cancel", autoClose: !1, twelveHour: !0, vibrate: !0 },
      i = function () {
    function i(e, n) {
      _classCallCheck(this, i), e.M_Timepicker && e.M_Timepicker.destroy(), this.el = e, this.$el = t(e), this.el.M_Timepicker = this, this.options = t.extend({}, i.defaults, n), this.id = M.guid(), this._insertHTMLIntoDOM(), this._setupModal(), this._setupVariables(), this._setupEventHandlers(), this._clockSetup(), this._pickerSetup();
    }return _createClass(i, [{ key: "destroy", value: function value() {
        ...
        t.preventDefault();var e = this.plate.getBoundingClientRect(),
            n = { x: e.left, y: e.top };this.x0 = n.x + this.options.dialRadius, this.y0 = n.y + this.options.dialRadius, this.moved = !1;var s = i._Pos(t);this.dx = s.x - this.x0, this.dy = s.y - this.y0, this.setHand(this.dx, this.dy, !1), document.addEventListener("mousemove", this._handleDocumentClickMoveBound), document.addEventListener("touchmove", this._handleDocumentClickMoveBound), document.addEventListener("mouseup", this._handleDocumentClickEndBound), document.addEventListener("touchend", this._handleDocumentClickEndBound);
      } }, { key: "_handleDocumentClickMove", value: function value(t) {
        t.preventDefault();var e = i._Pos(t),
            n = e.x - this.x0,
            s = e.y - this.y0;this.moved = !0, this.setHand(n, s, !1, !0);
      } }, { key: "_handleDocumentClickEnd", value: function value(t) {
        t.preventDefault(), document.removeEventListener("mouseup", this._handleDocumentClickEndBound), document.removeEventListener("touchend", this._handleDocumentClickEndBound);var e = i._Pos(t),
            n = e.x - this.x0,
            s = e.y - this.y0;this.moved && n === this.dx && s === this.dy && this.setHand(n, s), "hours" === this.currentView ? this.showView("minutes", this.options.duration / 2) : this.options.autoClose && (this.minutesView.addClass("timepicker-dial-out"), setTimeout(function () {
          this.done();
        ...
        this.$modalEl = t(i._template), this.modalEl = this.$modalEl[0], this.modalEl.id = "modal-" + this.id;var e = document.querySelector(this.options.container);this.options.container && e ? this.$modalEl.appendTo(e) : this.$modalEl.insertBefore(this.el);
      } }, { key: "_setupModal", value: function value() {
        var t = this;this.modal = new M.Modal(this.modalEl, { complete: function complete() {
            t.isOpen = !1;
          } });
      } }, { key: "_setupVariables", value: function value() {
        ...
        var e = t('<div class="timepicker-tick"></div>');if (this.options.twelveHour) for (var i = 1; i < 13; i += 1) {
          var n = e.clone(),
              s = i / 6 * Math.PI,
              a = this.options.outerRadius;n.css({ left: this.options.dialRadius + Math.sin(s) * a - this.options.tickRadius + "px", top: this.options.dialRadius - Math.cos(s) * a - this.options.tickRadius + "px" }), n.html(0 === i ? "00" : i), this.hoursView.appendChild(n[0]);
        } else for (var o = 0; o < 24; o += 1) {
          var r = e.clone(),
              l = o / 6 * Math.PI,
              h = o > 0 && o < 13 ? this.options.innerRadius : this.options.outerRadius;r.css({ left: this.options.dialRadius + Math.sin(l) * h - this.options.tickRadius + "px", top: this.options.dialRadius - Math.cos(l) * h - this.options.tickRadius + "px" }), r.html(0 === o ? "00" : o), this.hoursView.appendChild(r[0]);
        }
      } }, { key: "_buildMinutesView", value: function value() {
        for (var e = t('<div class="timepicker-tick"></div>'), n = 0; n < 60; n += 5) {
          var s = e.clone(),
              a = n / 30 * Math.PI;s.css({ left: this.options.dialRadius + Math.sin(a) * this.options.outerRadius - this.options.tickRadius + "px", top: this.options.dialRadius - Math.cos(a) * this.options.outerRadius - this.options.tickRadius + "px" }), s.html(i._addLeadingZero(n)), this.minutesView.appendChild(s[0]);
        }
        ...
        var t = ((this.el.value || this.options.defaultTime || "") + "").split(":");if (this.options.twelveHour && void 0 !== t[1] && (t[1].indexOf("AM") > 0 ? this.amOrPm = "AM" : this.amOrPm = "PM", t[1] = t[1].replace("AM", "").replace("PM", "")), "now" === t[0]) {
        ...
        "minutes" === e && t(this.hoursView).css("visibility");var n = "hours" === e,
            ...
            a = n ? this.minutesView : this.hoursView;this.currentView = e, t(this.spanHours).toggleClass("text-primary", n), t(this.spanMinutes).toggleClass("text-primary", !n), a.classList.add("timepicker-dial-out"), t(s).css("visibility", "visible").removeClass("timepicker-dial-out"), this.resetClock(i), clearTimeout(this.toggleViewTimer), this.toggleViewTimer = setTimeout(function () {
      ...
      } }, { key: "setHand", value: function value(t, e, n) {
        var s = this,
            a = Math.atan2(t, -e),
            ...
            d = h ? this.options.innerRadius : this.options.outerRadius;this.options.twelveHour && (d = this.options.outerRadius), a < 0 && (a = 2 * Math.PI + a);var u = Math.round(a / r);a = u * r, this.options.twelveHour ? o ? 0 === u && (u = 12) : (n && (u *= 5), 60 === u && (u = 0)) : o ? (12 === u && (u = 0), u = h ? 0 === u ? 12 : u : 0 === u ? 0 : u + 12) : (n && (u *= 5), 60 === u && (u = 0)), this[this.currentView] !== u && this.vibrate && this.options.vibrate && (this.vibrateTimer || (navigator[this.vibrate](10), this.vibrateTimer = setTimeout(function () {
          s.vibrateTimer = null;
        }, 100))), this[this.currentView] = u, o ? this.spanHours.innerHTML = u : this.spanMinutes.innerHTML = i._addLeadingZero(u);var c = Math.sin(a) * (d - this.options.tickRadius),
            p = -Math.cos(a) * (d - this.options.tickRadius),
            v = Math.sin(a) * d,
            f = -Math.cos(a) * d;this.hand.setAttribute("x2", c), this.hand.setAttribute("y2", p), this.bg.setAttribute("cx", v), this.bg.setAttribute("cy", f);
      } }, { key: "open", value: function value() {
        ...
        var n = this.el.value,
            s = e ? "" : i._addLeadingZero(this.hours) + ":" + i._addLeadingZero(this.minutes);this.time = s, !e && this.options.twelveHour && (s = s + " " + this.amOrPm), this.el.value = s, s !== n && this.$el.trigger("change"), this.close(), this.el.focus();
  ...
  var e = {},
      i = function () {
    function i(e, n) {
      _classCallCheck(this, i), e.M_CharacterCounter && e.M_CharacterCounter.destroy(), this.el = e, this.$el = t(e), this.el.M_CharacterCounter = this, this.options = t.extend({}, i.defaults, n), this.isInvalid = !1, this.isValidLength = !1, this._setupCounter(), this._setupEventHandlers();
    }return _createClass(i, [{ key: "destroy", value: function value() {
      ...
      var s = this;_classCallCheck(this, i), e.M_Carousel && e.M_Carousel.destroy(), this.el = e, this.$el = t(e), this.el.M_Carousel = this, this.options = t.extend({}, i.defaults, n), this.hasMultipleSlides = this.$el.find(".carousel-item").length > 1, this.showIndicators = this.options.indicators && this.hasMultipleSlides, this.noWrap = this.options.noWrap || !this.hasMultipleSlides, this.pressed = !1, this.dragged = !1, this.offset = this.target = 0, this.images = [], this.itemWidth = this.$el.find(".carousel-item").first().innerWidth(), this.itemHeight = this.$el.find(".carousel-item").first().innerHeight(), this.dim = 2 * this.itemWidth + this.options.padding || 1, this._autoScrollBound = this._autoScroll.bind(this), this._trackBound = this._track.bind(this), this.options.fullWidth && (this.options.dist = 0, this._setCarouselHeight(), this.showIndicators && this.$el.find(".carousel-fixed-item").addClass("with-indicators")), this.$indicators = t('<ul class="indicators"></ul>'), this.$el.find(".carousel-item").each(function (e, i) {
          ...
          if (n[0].complete) {
            var s = n.height();if (s > 0) this.$el.css("height", s + "px");else {
              var a = n[0].naturalWidth,
                  o = n[0].naturalHeight,
                  r = this.$el.width() / a * o;this.$el.css("height", r + "px");
            }
        ...
        var i = this;this.$el.hasClass("scrolling") || this.el.classList.add("scrolling"), null != this.scrollingTimeout && window.clearTimeout(this.scrollingTimeout), this.scrollingTimeout = window.setTimeout(function () {
          i.$el.removeClass("scrolling");
            ...
            d = void 0,
            u = void 0,
            c = this.center;if (this.offset = "number" == typeof e ? e : this.offset, this.center = Math.floor((this.offset + this.dim / 2) / this.dim), a = this.offset - this.center * this.dim, o = a < 0 ? 1 : -1, r = -o * a * 2 / this.dim, s = this.count >> 1, this.options.fullWidth ? h = "translateX(0)" : (h = "translateX(" + (this.el.clientWidth - this.itemWidth) / 2 + "px) ", h += "translateY(" + (this.el.clientHeight - this.itemHeight) / 2 + "px)"), this.showIndicators) {
  ...
  var e = {},
      i = function () {
    function i(e, n) {
      _classCallCheck(this, i), e.M_FeatureDiscovery && e.M_FeatureDiscovery.destroy(), this.el = e, this.$el = t(e), this.el.M_FeatureDiscovery = this, this.options = t.extend({}, i.defaults, n), this.isOpen = !1, this.$origin = t("#" + this.$el.attr("data-target")), this._setup(), this._calculatePositioning(), this._setupEventHandlers();
    }return _createClass(i, [{ key: "destroy", value: function value() {
        ...
        var e = "fixed" === this.$origin.css("position");if (!e) for (var i = this.$origin.parents(), n = 0; n < i.length && !(e = "fixed" == t(i[n]).css("position")); n++) {}var s = this.$origin.outerWidth(),
            ...
            B = y / 2 - D / 2,
            O = g / 2 - $ / 2,
            I = {};I.top = v ? _ + "px" : "", I.right = p ? l - k - g + "px" : "", I.bottom = f ? h - _ - y + "px" : "", I.left = c ? k + "px" : "", I.position = b, t(this.wrapper).css(I), t(this.contentEl).css({ width: w + "px", height: C + "px", top: E + "px", right: "0px", bottom: "0px", left: x + "px", padding: L + "px", verticalAlign: T }), t(this.waveEl).css({ top: B + "px", left: O + "px", width: $ + "px", height: D + "px" });
      } }, { key: "open", value: function value() {
  ...
  var e = { classes: "" },
      i = function () {
    function i(e, n) {
      _classCallCheck(this, i), e.M_Select && e.M_Select.destroy(), this.el = e, this.$el = t(e), this.el.M_Select = this, this.options = t.extend({}, i.defaults, n), this.isMultiple = this.$el.prop("multiple"), this._keysSelected = {}, this._valueDict = {}, this._setupDropdown(), this._setupEventHandlers();
    }return _createClass(i, [{ key: "destroy", value: function value() {
        ...
        e.preventDefault();var i = t(e.target).closest("li")[0],
          ...
          var s = !0;if (this.isMultiple) {
            var a = t(i).find('input[type="checkbox"]');a.prop("checked", !a.prop("checked")), s = this._toggleEntryFromArray(n);
        ...
        var e = this;this.wrapper = document.createElement("div"), this.wrapper.classList.add(), t(this.wrapper).addClass("select-wrapper " + this.options.classes), this.$el.before(t(this.wrapper)), this.wrapper.appendChild(this.el), this.el.disabled && this.wrapper.classList.add("disabled"), this.$selectOptions = this.$el.children("option, optgroup"), this.dropdownOptions = document.createElement("ul"), this.dropdownOptions.id = "select-options-" + M.guid(), t(this.dropdownOptions).addClass("dropdown-content select-dropdown " + (this.isMultiple ? "multiple-select-dropdown" : "")), this.$selectOptions.length && this.$selectOptions.each(function (i) {
          ...
          var n = {};this.isMultiple && (n.closeOnClick = !1), this.dropdown = new M.Dropdown(this.input, n);
        ...
        var s = i.disabled ? "disabled " : "",
            ...
            r = t("<li></li>"),
            l = t("<span></span>");l.html(o), r.addClass(s + " " + a), r.append(l);var h = i.getAttribute("data-icon");i.getAttribute("class");if (h) {
        ...
        var s = [];return e.each(function () {
          t(this).hasClass("browser-default") || s.push(new i(this, n));
        }), s;
      } }, { key: "getInstance", value: function value(t) {
  ...
  var i = {},
      n = function () {
    function n(e, i) {
      _classCallCheck(this, n), e.M_Range && e.M_Range.destroy(), this.el = e, this.$el = t(e), this.el.M_Range = this, this.options = t.extend({}, n.defaults, i), this._mousedown = !1, this._setupThumb(), this._setupEventHandlers();
    }return _createClass(n, [{ key: "destroy", value: function value() {
        ...
        var s = [];return e.each(function () {
          t(this).hasClass("browser-default") || s.push(new n(this, i));
        }), s;
      } }, { key: "getInstance", value: function value(t) {
